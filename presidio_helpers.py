%%writefile presidio_helpers.py
"""
Helper methods for the Presidio Streamlit app - Simplified version
"""
...
@st.cache_data
def get_supported_entities(model_family: str, model_path: str):
    """Return supported entities from the Analyzer Engine."""
    return analyzer_engine(model_family, model_path).get_supported_entities() + [
        "GENERIC_PII"
    ]


@st.cache_data
def analyze(model_family: str, model_path: str, **kwargs):
    ...
    return analyzer_engine(model_family, model_path).analyze(**kwargs)
