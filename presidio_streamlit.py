%%writefile presidio_streamlit.py
"""Streamlit app for Presidio - Simplified version with highlight only."""
import logging
import os
import traceback
...
st.set_page_config(
    page_title="Presidio demo - Highlight PII",
    layout="wide",
...
st.sidebar.header(
    """
PII Detection with [Microsoft Presidio](https://microsoft.github.io/presidio/)
"""
)
...
# Model list without Azure AI Language
model_list = [
...
st_model = st.sidebar.selectbox(
    "NER model package",
    model_list,
    index=0,  # Changed to 0 for spaCy as default (faster in Colab)
...
with st.expander("About this demo", expanded=False):
    ...
    - Highlight PII entities in text with color coding.
    - Configure allow and deny lists.
    
    This demo website shows Presidio's PII detection and highlighting capabilities.
...
try:
    ...
    demo_text = ["Hello, my name is John Doe and my email is john.doe@example.com. My phone number is 555-1234."]
